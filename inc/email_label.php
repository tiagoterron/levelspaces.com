...
<?php
$SQL = mysqli_query($connect, "SELECT * FROM `tb_template_email` WHERE `name` = 'label'");
...
<div class="row">
							<div class="col-md-12">
                                ...
                                <input type="hidden" value="sendEmailLabel" name="req" id="idReq" />
                                <input type="hidden" value="" name="type" id="idType" />
                                    ...
                                    <input type="text" required="required" name="venue" placeholder="Label name" value="">
